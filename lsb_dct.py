...
def Stego():
    print("--MENU--")
    print("1: Encode with LSB")
    print("2: Decode with LSB")
    print("3: Encode with DCT")
    print("4: Decode with DCT")
    ...
    if func == '1':
        ...
        print("Enter Message to Hide")
        message = input()
        dct_img_encoded = DCT().encode_image(img,message)
        dct_encoded_image_file = "dct_" + src
        ...
        img = cv2.imread(src, cv2.IMREAD_UNCHANGED)
        print("Decoding...")
        dct_hidden_text = DCT().decode_image(img)
        print("Hidden Message:",dct_hidden_text)
    else:
